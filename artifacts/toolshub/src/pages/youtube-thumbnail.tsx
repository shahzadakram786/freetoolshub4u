        ...
        {thumbnailUrl && (
          <div className="animate-in fade-in space-y-6">
            ...
            <Card className="overflow-hidden shadow-2xl p-2 border border-border/50 bg-muted/20">
              <img src={thumbnailUrl} alt="Video Thumbnail" className="w-full h-auto rounded-xl" />
            </Card>
            <div className="flex justify-center">
              <Button size="lg" className="gap-2" asChild>
                <a href={thumbnailUrl} target="_blank" rel="noopener noreferrer" download="thumbnail.jpg">
